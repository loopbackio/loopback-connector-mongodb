...
MongoDB.prototype.connect = function (callback) {
    if (this.db) {
        ...
        var self = this;
        mongodb.MongoClient.connect(this.settings.url, this.settings, function (err, db) {
            self.db = db;
 ...
 * @private
 */
MongoDB.prototype.getIdValue = function(model, data) {
 ...
 * @private
 */
MongoDB.prototype.setIdValue = function(model, data, value) {
    if(data) {
