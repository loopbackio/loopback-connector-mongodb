...
MongoDB.prototype.create = function(modelName, data, options, callback) {
  ...
  // generated defaults to true for mongodb: {dataType: 'objectId'}
  if ((hasDataType('objectid', propDef)) && propDef.generated !== false) {
    propDef.generated = true;
  }

  if (propDef.generated && idValue) {
