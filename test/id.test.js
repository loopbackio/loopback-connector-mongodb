...
describe('autogenerated ids', function() {
  ...
  const Customer2 = ds.createModel(
    'customer2',
    {id: {id: true, type: String}, name: String, emails: [String], age: Number},
    {forceId: false},
  );

  before(function(done) {
    Customer1.deleteAll(function() {
      Customer2.deleteAll(done);
    });
  });
  ...
  it('should require value for non-autogenerated id', function(done) {
    Customer2.create(
      {
        name: 'John1',
        emails: ['john@x.com', 'john@y.com'],
      ...
      function(err, customer) {
        err.message.should.match(/Value is required for non-autogenerated id/);
        done();
      },
    );
  });
...
describe('non-generated ObjectId id', function() {
  const Book = ds.createModel(
    'Book',
    {id: {type: String, mongodb: {dataType: 'ObjectId'}, id: true, generated: false}, title: String},
  );
  ...
  let id;
  it('should be able to specify custom ObjectId id value', function(done) {
    Book.create(
      {
